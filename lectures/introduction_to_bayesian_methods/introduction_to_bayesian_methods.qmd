...
- Lots of code though throughout today...
...
- Version control to interface with (`RStudio`).
- This is just for information, as you will not be expected to be an expert on `GitHub` to participate in this workshop.
...
- We will be focusing on using `NIMBLE` throughout today.
